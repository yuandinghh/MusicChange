...
//csharp Data/ComplaintRepository.cs
//using System;
//using System.Collections.Generic;
//using System.Data;
//using System.Data.SQLite;
...
//            using var cmd = new SQLiteCommand(sql, conn);
//            cmd.Parameters.AddWithValue("@Main_id", (object?)model.MainId ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@complaint", (object?)model.complaint ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@username", (object?)model.username ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@complaint_feedback", (object?)model.complaint_feedback ?? DBNull.Value);
//            var id = Convert.ToInt32(cmd.ExecuteScalar() ?? 0);
//            return id;
//        }
...
//        {
//            const string sql = "DELETE FROM complaint WHERE id = @id;";
//            using var conn = new SQLiteConnection(_connectionString);
//            conn.Open();
//            using var cmd = new SQLiteCommand(sql, conn);
//            cmd.Parameters.AddWithValue("@id", id);
...
//        private static Complaint MapReader(IDataRecord r)
//        {
//            return new Complaint
//            {
//                Id = Convert.ToInt32(r["id"]),
//                MainId = r["Main_id"] == DBNull.Value ? null : (int?)Convert.ToInt32(r["Main_id"]),
//                complaint = r["complaint"] == DBNull.Value ? null : Convert.ToString(r["complaint"]),
//                username = r["username"] == DBNull.Value ? null : Convert.ToString(r["username"]),
//                complaint_feedback = r["complaint_feedback"] == DBNull.Value ? null : (int?)Convert.ToInt32(r["complaint_feedback"]),
//                CreatedAt = r["created_at"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(r["created_at"])
//            };
//        }
//    }
