...
namespace MusicChange
{
	...
	public class ToolTipEx : ToolTip
	{
		...
		{
			get  => _titleFont ?? new Font( SystemFonts.DefaultFont.FontFamily, SystemFonts.DefaultFont.Size + 10, FontStyle.Bold );
		...
		private void DrawText(Graphics g, Rectangle contentRect, string text, Rectangle? titleRect, Rectangle? iconRect)
		{
			using (var brush = new SolidBrush( ForeColor )) {
				...
				TextRenderer.DrawText( g, text, this.TitleFont, contentRect, ForeColor, flags );
			}
		}
		...
		#region 公共方法
		public void SetToolTip(Control control, string title, string text, System.Drawing.Image icon = null)
		{
			_titleText = title;
			_icon = icon;
