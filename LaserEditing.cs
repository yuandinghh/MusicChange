		...
		private void InitializeLibVLC()
		{
			...
			catch(Exception ex)
			{
				...
				CleanupResources();
					...
					// 添加音量控制相关字段
			private Panel _volumeControlPanel;
			private Button _volumeUpButton;
			private Button _volumeDownButton;
			private Button _muteButton;
			private Panel _volumeBarBackground;
			private Panel _volumeBarIndicator;
			...
			private void InitializeVolumeControls()
			{
				...
				_volumeUpButton.Click += VolumeUpButton_Click;

				// 创建音量减少按钮
				_volumeDownButton = new Button
				{
					Text = "-",
					Size = new Size(25, 25),
				...
				_volumeDownButton.Click += VolumeDownButton_Click;
				...
				// 创建音量条背景
				_volumeBarBackground = new Panel
				{
					Size = new Size(15, 30),
				...
				{
					Size = new Size(15, 15), // 初始高度为一半
					Location = new Point(0, 15), // 从底部开始
					BackColor = Color.LimeGreen
				};
				_volumeBarBackground.Controls.Add(_volumeBarIndicator);
				...
				_volumeControlPanel.Controls.Add(_volumeBarBackground);
			...
			{
				if(_volumeBarBackground == null || _volumeBarIndicator == null)
					return;
				...
				// 计算新的高度和位置
				int maxHeight = _volumeBarBackground.Height;
				...
				// 根据音量大小改变颜色
				if(volume < 30)
					_volumeBarIndicator.BackColor = Color.LimeGreen;
				else if(volume < 70)
					_volumeBarIndicator.BackColor = Color.Yellow;
				else
					_volumeBarIndicator.BackColor = Color.Red;
			}
